...
if (!file.exists(here(local_dir, local_name))) {
  ...
  download.file(url, destfile = here(local_dir,"Gravity_csv_V202211"))
  unzip(here(local_dir,"Gravity_csv_V202211"), exdir = here(local_dir,"gravity_data"))
  ...
  unlink(here(local_dir,"Gravity_csv_V202211"), recursive = TRUE)
