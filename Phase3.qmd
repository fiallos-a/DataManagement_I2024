...
A notable innovation in our approach is the inclusion of internet coverage as an explanatory variable for both the reporting and partner countries. The model specification is as follows:
...
\begin{itemize}
    ...
    \item \textbf{factor(partner)}: Fixed effects of partner country $j$.
