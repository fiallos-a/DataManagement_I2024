...
text <- pdf_text("Phase3.pdf")
word_count <- strsplit(text, "\\s+") %>% unlist() %>% length()
cat("Wordcount =", word_count)
```
...
modelsummary(models,
             ...
             notes = list("Significance levels: * p<0.05, ** p<0.01, *** p<0.001")) %>%
